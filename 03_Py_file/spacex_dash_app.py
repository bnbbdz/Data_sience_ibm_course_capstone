...
spacex_df = pd.read_csv(r"D:\03. Learning\01. Coder\00. Git_code_backup\Coursera_data_science\Code\Python\08. Data_sience_capstone\SpaceX_DataSet\spacex_launch_dash.csv")
